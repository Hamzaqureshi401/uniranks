<x-base-layout>
    <x-shared.general.breadcrumb-bar>
        <h4 class="ps-4 mb-0">@lang('University Representative Login')</h4>
    </x-shared.general.breadcrumb-bar>
...
{{--        <x-general.auth-button-group/>--}}
        <div class="d-flex flex-column justify-content-end mt-3 h-100">
            ...
            <div id="auth_form_login_tab">
                ...
                <p class="mb-4 primary-text">@lang('Enter your registered email to sign in')
{{--                    <a href="{{route('register')}}" class="secondary-text">@lang('signup')</a> @lang('to continue.')</p>--}}
