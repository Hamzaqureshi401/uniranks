<div>
    <x-general.university-media-page-title sub-title="University Panorama 360 Galleries" gallery-menu="true" />
    <livewire:media.create-media-album-form content-type="{{\App\Models\Multimedia\Media::TYPE_PENORAMA}}" />
    @php
        /**
    ...
    @if(!empty($selected_album))
        <div class="card mt-4" id="upload-images-div">
            <div class="card-body">
                <div class="w-100">
                    <div class="">
                        <div class="paragraph-style2 blue">@lang('Add Panorama 360 link').</div>
                        <div class="row mt-3">
                            <div class="col-md-8">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-floating w-100">
                                    ...
                                    <label for="floatingInput">@lang('Link')</label>
                                </div>
        ...
        <div class="bg-transparent card border-none">
            <div class="bg-light-blue p-2 px-4 d-md-flex justify-content-between align-items-center">
                <div class=""><a href="#upload-images" class="white">@lang('Add More 360') </a></div>
                <div class="col-md-4 mobile-marg-2">
                    <select wire:model="album_id" wire:change="loadAlbumData" class="input-field form-control">
                        <option value="">@lang('Select Album')</option>
