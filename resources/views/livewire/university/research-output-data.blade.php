<div>
   ...
   <div class="card">
      <div class="card-body">
         ...
         @include('livewire.university.research-output-data-pages.journal-subjects-aarea')
         @include('livewire.university.research-output-data-pages.journal-volume')
         @include('livewire.university.research-output-data-pages.journal-logos')
   ...
   @include('livewire.university.research-output-data-pages.list-saved-data')
