<div>
    ...
    **/
    @endphp
    <div class="card mt-3" x-data="{photoName: null, photoPreview: null,isUploading: false, progress: 0}"
        ...
        <div class="card-body">
            <div class="blue paragraph-style2">
                @lang('UNIRANKS require two types of Logos, Rectangle and Square')
            </div>
            ...
            <div>
                ...
                <div class="d-md-flex mt-3 justify-content-between align-items-center">
                    <div class="col-md-6">
                        ...
                        <div x-show="isUploading" class="mt-2" style="width: 250px" >
                            <div class="progress">
