            ...
            <div class="d-md-flex mt-3 justify-content-between align-items-center">
               <div class="col-md-6">
                  <div x-show="!photoPreview">
                     <img src="{{$rectangle_logo_path ?? $university->monogram_url}}" x-on:click.prevent="$refs.photo.click()" style="cursor:pointer;" class="card p-2 rounded-0" width="250px">
                  </div>
         ...
         <div class="card mt-1" x-data="{photoName: null, photoPreview: null,isUploading: false, progress: 0}"
            ...
            <div class="d-md-flex mt-3 justify-content-between align-items-center">
               <div class="col-md-6">
                  ...
                  <div x-show="!photoPreview">
                     <img src="{{$square_logo_path ?? $university->monogram_url}}" x-on:click.prevent="$refs.photoSquare.click()" style="cursor:pointer;" class="card p-2 rounded-0" width="130px">
                  </div>
                  <div x-show="photoPreview" style="display: none;">
