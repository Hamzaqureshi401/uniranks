<div>
    @php
        $links = [
            ['title'=>'Undergraduate','route'=>'admin.university.admissionRequirements.entryTest.undergraduate'],
            ['title'=>'Postgraduate','route'=>'admin.university.admissionRequirements.entryTest.postgraduate'],
            ['title'=>'PHD','route'=>'admin.university.admissionRequirements.entryTest.phd'],
            ]
    @endphp
...
{{--                    </div>--}}
   ...
   <div class="card-body">
      <div class="h4 blue"> @lang('Entry Test ')</div>
