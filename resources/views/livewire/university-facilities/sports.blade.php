...
<div class="card bg-transparent mt-4">
   <div class="card-body">
      ...
      <div>
         ...
         <tbody>
            @forelse($allSports as $sport)
            <tr class="blue">
               <td>{{ $sport->sportsType->name }}</td>
               <td>{{ $sport['title'] ?? '' }}</td>
               ...
               <td>{{ $sport['panorama_url'] }}</td>
                <td><a wire:click="editSport({{ $sport->id }})" href="javascript:void(0)" class="light-blue ms-2">Edit</a>
...
<x-jet-modal wire:model="isModalOpen">
   ...
   <div class="row mt-2">
               <div class="col-md-6">
                  <div class="form-floating w-100">
                     <select wire:model.defer="edit_item.sports_type_id"
                        class="form-select input-field">
                        <option value="">@lang('Sports Category')</option>
                        @foreach($categories as $category)
                        <option value="{{$category->id}}">{{$category->name}}</option>
               ...
               <div class="col-md-6">
                  <div class="form-floating w-100">
                     <select wire:model.defer="edit_item.sports_name_id"
                        class="form-select input-field">
                        <option value="">@lang('Sport')</option>
                        @foreach($sports as $sport)
                        <option value="{{$sport->id}}">{{$sport->name}}</option>
