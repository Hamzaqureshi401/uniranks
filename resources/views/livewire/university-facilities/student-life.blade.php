<div>
    <x-general.university-facility-page-title sub-title="University Student Life Services"/>
    <div class="card mt-3">
        <div class="card-body">
            <div class="blue">@lang('University Student Life Service Information')</div>
            ...
            <div>
                @php
                    /**
                    * @var \App\Models\University\UniversityClubType [] $categories
                    * @var \App\Models\University\Facility\UniversityFacilityStudentLife $service_information
                    **/
                @endphp
                <div class="row mt-2">
                    <div class="col-md-12">
                        <div class="form-floating w-100">
                            <select wire:model.defer="service_information.club_type_id"
                ...
                <div class="row">
                    <div class="col-md-6 mt-3">
                        <div class="form-floating w-100">
                            <div class="form-floating w-100">
                                <input type="text" wire:model.defer="service_information.video_url"
                    ...
                    <div class="col-md-6 mt-3">
                        <div class="form-floating w-100">
                            <input type="text" wire:model.lazy="service_information.panorama_url"
                                   class="form-control input-field"
    ...
    @php
        /**
        * @var \App\Models\University\Facility\UniversityFacilityStudentLife[] $dataCollection
    ...
    <div class="row align-items-baseline">
        <div class="col-md-8">
            <select wire:model="item_id" wire:change="loadAlbumData" class="input-field form-control">
                <option value="">@lang('Select Student Life Service')</option>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="h5 text-center blue d-flex justify-content-center">
                                ...
                                &nbsp;
                                @lang('Select student life service to view or update Images')
                            </div>
                        </div>
                    </div>
                </div>
