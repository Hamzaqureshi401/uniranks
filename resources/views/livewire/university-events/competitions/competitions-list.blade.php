                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 d-md-flex justify-content-between blue align-items-center">
                            <div class="col-12 col-md-6 ">
                                <span class="blue h5">@lang('List of Competitions')</span>
                                <span class="gray mx-2 h5">|</span>
                                <div class="w-100 d-block d-md-none my-1"></div><!--to force new line-->
                                <a href="{{ route('admin.events.competitions.create') }}" class="light-blue h5">@lang('Create a New Competition')</a>
                            </div>
                            ...
                            @forelse($openDays as $openDay)
                                <tr>
                                    ...
                                    <td style="width: 10%">
                                        ...
                                        @endif
                                        <a href="{{ route('admin.events.competitions.edit', $openDay->id) }}" class="blue h6"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                        <a href="{{ route('admin.events.competitions.view', $openDay->id) }}" class="blue h6"><i class="fas fa-eye" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
