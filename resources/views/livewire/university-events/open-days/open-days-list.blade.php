                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-12 d-md-flex justify-content-between blue align-items-center">
                            <div class="col-12 col-md-6 ">
                                <span class="blue h5">@lang('List of Open Days')</span>
                                <span class="gray mx-2 h5">|</span>
                                <div class="w-100 d-block d-md-none my-1"></div><!--to force new line-->
                                <a href="{{ route('admin.events.openDays.create') }}" class="light-blue h5">@lang('Create a New Open Days')</a>
                            </div>
                            ...
                            @forelse($openDays as $openDay)
                                <tr>
                                    ...
                                    <td style="width: 10%">
                                        ...
                                        @endif
                                        <a href="{{ route('admin.events.openDays.edit', $openDay->id) }}" class="blue h6"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                        <a href="{{ route('admin.events.openDays.view', $openDay->id) }}" class="blue h6"><i class="fas fa-eye" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
