<div class="col-lg-12 col-sm-12"> 
            ...
            <form class="" wire:submit.prevent="">
                <div class="row">
                    <div class="col-lg-12 d-flex">
                        ...
                        <input class="form-control input-field" wire:model.lazy="title" placeholder="@lang("Name the fair (By default will be University Name Student for a Day)")">
                    </div>
                </div>
                @php
                    /**
    ...
    @endphp
    @if(!empty($event))
        <div class="h4 blue mt-5">@lang('Edit Student for a Day History')</div>
        @foreach($event->history as $history)
            ...
            <div class="card bg-transparent mt-3">
                <div class="card-body">
                    <div class="w-100">
                        <div class="row mt-2">
                            <div class="paragraph-style2">@lang('Student for a Day') <span
