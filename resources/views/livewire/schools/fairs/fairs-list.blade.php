               ...
               <div class="card">
                  <div class="p-3">
                     ...
                     @if($events_credit > 0)
                        ...
                        <button class="button-sm button-blue m-0 w-100 regsiter-button-div ms-2"
                           wire:click="acceptFair('{{$fair->id}}')">@lang('Accept')</button>
                     @else
                     ...
                     @else
                     @if($events_credit > 0)
                        <button class="button-sm button-blue m-0 w-100 mobile-btn"
                           wire:click="acceptFair('{{$fair->id}}')">@lang('Accept')</button>
               ...
               <div class="row">
                  ...
                  <!-- <div class="col-12 mt-3">
                     ...
                     @if(now() < $fair->end_date)
                            ...
                            @elseif(now() > $fair->end_date)
                                <span style="color: #ae1414; margin-left: 17px;">@lang('Expired')</span>
                            @else
                                <span style="color: #ae1414; margin-left: 17px;">@lang('Closed')</span>
                            @endif
