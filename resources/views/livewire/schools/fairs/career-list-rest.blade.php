   ...
   <div class="card mt-3">
      <div class="p-3">
         <div class="row">
            <div class="col-md-2" style="width: 9.666667% !important;">
               <div class="row">
                  ...
                  <div class="col-12 mt-2">
                     ...
                     <span style="color: green; margin-left: 17px;">{{ 'Active' }}</span>
                     @else
            ...
            <div class="col-md-3 mt-4" style=" width: 30% !important;  border-left: 1px solid #ccc; margin-left: -22px;">
               <div class="h6 mb-0 gray">
                   <div class="row">
                     <div class="col-md-12">@lang('Fees') {{$fair->school?->g_12_fee_range?->currency_range}}</div>
                     <div class="col-md-12 mt-3">@lang('Grade 12 Students')
 ...
 <div class="card mt-3">
      <div class="p-3">
         <div class="row">
            <div class="col-md-2" style="width: 9.666667% !important;">
               <div class="row">
                  ...
                  <div class="col-12 mt-2">
                     ...
                     <span style="color: green; margin-left: 17px;">{{ 'Active' }}</span>
                     @else
                     <span style="color: red; margin-left: 17px;">{{ 'In Active' }}</span>
                     @endif
                  </div>
               </div>
            </div>
            ...
            <div class="col-md-3 mt-4" style=" width: 30% !important;  border-left: 1px solid #ccc;">
               <div class="h6 mb-0 gray">
                   <div class="row">
                     <div class="col-md-12">@lang('Fees') {{$fair->school?->g_12_fee_range?->currency_range}}</div>
                     <div class="col-md-12 mt-3">@lang('Grade 12 Students')
