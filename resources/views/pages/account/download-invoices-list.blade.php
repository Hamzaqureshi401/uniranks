...
<x-print-layout :title="$title">
    <div class="row">
        <div class="col-12">
            @php
                /**
                * @var \App\Models\Transactions\Invoice[] $invoices
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        <h1 class="h1"><b>@lang('Invoice List')</b></h1>
                    ...
                    <td colspan="2">
                        <table style="width: 100%; border: solid 1px #ccced0; border-collapse: collapse">
                            ...
                            <tr style="background: #1c345a !important; ">
                                ...
                                <td style="color: white; padding: .5rem .5rem;">@lang('Invoice#')</td>
                                <td style="color: white; padding: .5rem .5rem;">@lang('Status')</td>
                                <td style="color: white; padding: .5rem .5rem;">@lang('Currency')</td>
                                <td style="color: white; padding: .5rem .5rem;">@lang('Amount')</td>
                                <td style="color: white; padding: .5rem .5rem;">@lang('Payment Method')</td>
                            </tr>
                            <!--End Heading row-->
                            </thead>
                            <tbody>
                            ...
                            <tr>
                                ...
                                <td style="padding: .5rem .5rem;
                                 border-bottom: 1px solid #ccced0;">{{$invoice->transaction_details}}</td>
                                <td style="padding: .5rem .5rem;
                                 border-bottom: 1px solid #ccced0;">{{$invoice->invoice_number}}</td>
                                <td style="padding: .5rem .5rem;
                                 border-bottom: 1px solid #ccced0;">
                                    @if($invoice->due_date?->isPast())
                                        <label style="color: red">@lang('Over Due')</label>
                                    @else
                                        <label>{{$invoice->payment_status_name}}</label>
                                    @endif
                                </td>
                                <td style="padding: .5rem .5rem;
                                 border-bottom: 1px solid #ccced0;">{{$invoice->currency?->code}}</td>
                                <td style="padding: .5rem .5rem;
                                 border-bottom: 1px solid #ccced0;">{{number_format($invoice->payable_amount,2)}}</td>
                                <td style="padding: .5rem .5rem;
                                 border-bottom: 1px solid #ccced0;">
                                    @if($invoice->payment_status == AppConst::APPROVED)
