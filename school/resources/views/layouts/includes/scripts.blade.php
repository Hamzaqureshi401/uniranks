...
<script type="text/javascript">
    ...
    function comingSoon(event){
        ...
        let myModal = new bootstrap.Modal(document.getElementById('coming-soon-popup'));
        myModal.show();
    }
    ...
    $(window).on('load', function () {
        ...
        // $('.coming-soon').click(comingSoon);
        const coming_soon_divs = document.querySelectorAll('.coming-soon');
        coming_soon_divs.forEach(el => {
