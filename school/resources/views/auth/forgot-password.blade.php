<x-base-layout>
    ...
    <x-general.authentication-card>
        <div class="d-flex flex-column justify-content-end h-100">
            <div class="">
                <h4 class="mb-0 primary-text" >@lang('Forget Password')</h4>
                <span class="primary-text">@lang('Please enter your registered email id to reset your password.')</span>
            </div>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                @csrf
                <div class="mt-5">
                    <input class="form-control mb-3 input-field" placeholder="@lang('Email')"
