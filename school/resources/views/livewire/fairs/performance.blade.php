                ...
                <div class="p-3">
                    ...
                    @php
                        ...
                        if ($school_students_count > 0){
                            $percentage = round(($fair->attendance_count * 100)/$school_students_count,1);
                    ...
                    <div class="row mt-2">
                        <div class="col mb-2">
                            <h3 class="h3 blue">{{__($event_rank)}}</h3>
                        </div>
                    </div>
                    <div class="row mt-2">
        ...
        <div class="col-lg-3 col-md-4">
            <div class="card">
                <div class="p-3">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <h3 class="h3 blue">{{__('No Ratings')}}</h3>
                        </div>
                    </div>
                    @else
                    <div class="row mt-4">
                    ...
                    @endif
                    <div class="row mt-4">
                        <p class="blue paragraph-style2 mt-2">@lang('Rated by') {{$fair->rated_by_count}} @lang('Users')</p>
                    </div>
                </div>
            </div>
        </div>
