<div>
    <div class="row">
        <div class="col-12">
            <h5 class="h5 mb-3">
                <span class="primary-text">@lang('Career Talks list')</span>
                        ...
                        <div class="d-lg-flex align-self-start">
                            ...
                            <div class="flex-fill pe-4">
                                <div class="row light-blue d-block d-md-flex">
                                    <div class="col col-md-6">{{$fair->fair_name}}</div>
                                    <div class="col col-md-6 text-md-end">{{Helpers::dayDateTimeFormat($fair->start_date)}}
                                        - {{Helpers::dayDateTimeFormat($fair->end_date)}}</div>
                                </div>
                                ...
                                <div class="row mt-1 mobile-marg-2 blue d-block d-md-flex">
                                    ...
                                    <div class="col col-md-2 d-flex d-md-block">
                                        <div>@lang('No.Sess')<span class="d-md-none">: &nbsp;</span></div>
                                        <div class="">{{$fair->sessions_count}}</div>
                                    </div>
                                    <div class="col col-md-2 d-flex d-md-block">
                                        <div>@lang('Students')<span class="d-md-none">: &nbsp;</span></div>
                                        <div class="">
                                            <a class="light-blue" href="{{route('admin.school.fair.confirmedStudents',$fair->id)}}"
                                    ...
                                    <div class="col col-md-2 d-flex d-md-block align-items-center">
                                        ...
                                        <div class="">
                                            <a class="light-blue" href="{{route('admin.school.career-talk.registeredUniversities',$fair->id)}}"
                                               title="Click to view full list">
                                    ...
                                    <div class="col col-md-2 text-md-end d-flex d-md-block align-items-center">
                                        ...
                                        <div class="blue h6 text-place-end mb-0">
                                            @if($fair->is_editable)
                                                <a href="{{route('admin.school.career-talk.edit',$fair->id)}}" class="primary-text">@lang('Edit')</a>
                                                <a href="javascript:void(0)" wire:click="openModalConfirmModal({{$fair->id}})" class="red">@lang('Delete')</a>
                                            @endif
                                            <a href="{{route('admin.school.career-talk.view',$fair->id)}}" class="primary-text">@lang('View')</a>
