            ...
            <div class="row">
                ...
                <div class="col-12 col-md-7" x-init="$nextTick(() => {
                    new Chart('pie-chart', {
                        type: 'pie',
                        data: {
                            labels: ['{{ $students_hasMajor_count }} {{ __('Students which is') }} {{ $hasMajors_percentage }}%  {{ __('have selected majors') }}', '{{ $students_noMajor_count }} {{ __('Students which is') }} {{ $noMajors_percentage }}% {{ __('did not selected majors yet') }}'],
                            datasets: [{
