                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{__('% of how many students selected each major')}}</td>
                            ...
                            @forelse ($majors as $key => $major)
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.school.statistics.majors.studentList')}}?major_id={{$major->id}}" class="primary-text"><i class="fa-solid fa-eye"></i></a></td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="10">
