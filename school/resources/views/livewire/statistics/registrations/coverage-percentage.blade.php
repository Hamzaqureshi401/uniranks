            ...
            <div class="w-100">
                ...
                <div class="row">
                    <div class="col-12 col-md-5 blue">
                        ...
                        <p class="paragraph-style2 my-2">{{__("Remind students who didn't register or complete their profiles to register and complete their profiles.")}}</p>
                        <button class="button-sm button-dark-blue mx-0" wire:click="sendReminder">{{__("Send Reminder to Students Now!")}}</button>
