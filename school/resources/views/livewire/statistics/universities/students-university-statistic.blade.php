                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-7" x-init="$nextTick(() => {
                        new Chart('pie-chart', {
                            type: 'pie',
                            data: {
                                labels: ['{{ $students_selectUniversity_count }} {{ __('Students which is') }} {{ $selectUniversities_percentage }}% {{ __('have selected a university') }}', '{{ $students_noUniversity_count }} {{ __('Students which is') }} {{ $notUniversities_percentage }}% {{ __('did not selected a university yet') }}'],
                                datasets: [{
