        ...
        <div class="w-100">
            <div class="row">
                <div class="col-12 blue mb-3">
                    ...
                    <p class="paragraph-style2 my-2 font-weight-bold">{{ $total_count }} {{ __("Students have already selected their university of choice") }}</p>
                ...
                <div class="col-12 mt-3" x-init="$nextTick(() => {
                    new Chart('pie-chart', {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: '{{ __('University Selection Statistic Pie Chart') }}',
