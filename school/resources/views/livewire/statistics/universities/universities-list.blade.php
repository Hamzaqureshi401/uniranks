                    ...
                    <table width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="w-40">{{__('% of how many students selected each university')}}</td>
                                <td class="w-5">{{ __('No. Students') }}</td>
                            ...
                            @forelse ($universities as $key => $university)
                                <tr>
                                    ...
                                    <td class="text-end"><a href="{{route('admin.school.statistics.universities.studentList')}}?university_id={{$university->id}}" class="primary-text"><i class="fa-solid fa-eye"></i></a></td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="10">
