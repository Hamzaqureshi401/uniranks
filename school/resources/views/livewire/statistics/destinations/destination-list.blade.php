                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="w-40">{{__('% of how many students selected each country')}}</td>
                            ...
                            @forelse ($destinations as $key => $destination)
                                <tr>
                                    ...
                                    <td><a href="{{route('admin.school.statistics.destinations.studentList')}}?destination_id={{$destination->id}}" class="primary-text"><i class="fa-solid fa-eye"></i></a></td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="10">
