          ...
          <div class="row" >
            ...
            <div class="col-12 col-md-7"
                 x-init="$nextTick(() => {new Chart('pie-chart',{
                   type: 'pie',
                   data: {
                   labels: [ '{{ $students_selectDestination_count }} {{ __('Students which is') }} {{ $selectDestinations_percent }}% {{ __('have selected destination') }}','{{ $students_noDestination_count }} {{ __('Students which is') }} {{ $noDestinations_percent }}% {{ __('did not selected destination yet') }}'],
                   datasets: [{
