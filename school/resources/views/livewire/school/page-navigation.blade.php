<div class="container d-flex align-items-center top-menu-container mb-4">
    ...
    <div class="dropdown menu-item">
        ...
        <ul class="dropdown-menu1 shadow-sm dropdown-menu dropdown-menu-header" aria-labelledby="dropdownMenuLink">
            ...
            <li><a class="dropdown-item pt-3 font-1 font-light" href="{{route('admin.school.information')}}?t=user-personal-info">
                    @lang('Basic Info')</a></li>
            <li><a class="dropdown-item pt-3 font-1 font-light" href="{{route('admin.school.information')}}?t=user-emails">
                    @lang('Primary Email Address')</a></li>
            <div class="dropdown-divider"></div>
            <li><a class="dropdown-item font-1 font-light" href="{{route('admin.school.information')}}?t=user-phone-number">
                    @lang('Phone numbers')</a></li>
            <div class="dropdown-divider"></div>
            <li><a class="dropdown-item font-1 font-light" href="{{route('admin.school.information')}}?t=user-password">
...
{{--                    @lang('Trips')</a></li>--}}
    ...
    <div class="dropdown  menu-item">
        ...
        <ul class="dropdown-menu shadow-sm  dropdown-menu-header dropdown-menu2" aria-labelledby="dropdownMenuLink">
            ...
            <div class="dropdown-divider"></div>
            <li><a class="dropdown-item font-1 font-light coming-soon" href="{{route('admin.school.requestMeeting')}}">
                    @lang('Request a Meeting S2U')</a></li>
            <div class="dropdown-divider"></div>
            <li><a class="dropdown-item font-1 font-light coming-soon" href="{{route('admin.school.requestPresentation')}}">
            ...
            <div class="dropdown-divider"></div>
            <li><a class="dropdown-item font-1 font-light coming-soon" href="{{route('admin.school.studentTour.list')}}">
...
{{--                    @lang('Exhibitions & Fairs')</a></li>--}}
    ...
    <div class="dropdown menu-item">
        ...
        <ul class="dropdown-menu shadow-sm dropdown-menu-header dropdown-menu3" aria-labelledby="dropdownMenuLink">
            ...
            <li><a class="dropdown-item pt-3 font-1 font-light coming-soon" href="{{route('admin.school.students.application.list')}}">
                    @lang('Applications List')</a></li>
{{--            <div class="dropdown-divider"></div>--}}
{{--            <li><a class="dropdown-item font-1 font-light coming-soon" href="{{route('admin.school.students.application.attachLetter')}}">--}}
