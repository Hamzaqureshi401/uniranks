<div>
                    ...
                    <div class="w-100">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-md-6 mobile-marg-2">
                                <input wire:model.lazy="invitiees.{{$i}}.name" class="form-control input-field" placeholder="{{__("University name")}}"/>
                                <x-jet-input-error for="invitiees.{{$i}}.name" class="mt-2" />
                            </div>
                            <div class="col-12 col-md-6 mobile-marg-2">
                                <input wire:model.lazy="invitiees.{{$i}}.email" type="email" class="form-control input-field" placeholder="{{__("University email")}}"/>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 mobile-marg-2">
                                <label for="contacts" class="gray mb-1">@lang('university_name-university_email;....')</label>
                                <textarea id="contacts" wire:model.defer="contacts" rows="4" class="form-control"
                                          placeholder="Copy and paste in exactly same format: university1_name-email; university2_name-email; university3_name-email;..."></textarea>
    ...
    <x-general.loading wire:target="sendInvitation" message="Sending Invitation" />
</div>
