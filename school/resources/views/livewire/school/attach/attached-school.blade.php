                ...
                <div class="card">
                    <div class="card-body p-3 d-flex justify-content-between">
                        ...
                        <a class="light-blue" href="javascript:void(0)"
                           onclick="attachUserWithSchool('{{$user_school->id}}','{{$user_school->school_name}}')">
                            @lang('Link user to this school')</a>
                    </div>
                </div>
            </div>
        </div>
    @endforeach
    <x-account-attached-to-school-alert-message/>
{{--Model For New User--}}
    ...
    @push(AppConst::PUSH_JS)
        <script>
            ...
            Livewire.on('userSaved', () => {
                ...
                const alertMessage = new bootstrap.Modal($('#accountAttached'));
                alertMessage.show();
            })
