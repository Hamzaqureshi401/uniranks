     ...
     <div class="row my-3">
        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <select wire:model="search_source" name="search_source" class="text-start form-control input-field" aria-label=""
                            wire:change="loadHistory">
                ...
                <div class="col-3">
                    <select wire:model="search_transaction" name="search_transaction" class="text-start form-control input-field" aria-label=""
                            wire:change="loadHistory">
                ...
                <div class="col-3">
                    <x-elements.date-range-picker wire:model="search_period" placeholder="Select Period" wire:change='loadHistory'  />
                </div>
            </div><br>
            <div class="card">
