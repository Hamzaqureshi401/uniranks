...
{{--                        href="{{route('admin.school.studentTour.list')}}">@lang('Student Tour')</a></li>--}}
            ...
            <ul class="sidebar-ul">
                <li class="mb-2">
                    <a @class(['a-underline blue coming-soon','light-blue' => Route::is('admin.school.tours.show')])
                                    href="{{route('admin.school.tours.show')}}">@lang('International Tours Visit List')
                    </a>
                </li>
                ...
                <li class="mb-2"><a @class(['a-underline blue coming-soon','light-blue' => Route::is('admin.school.join.studentTour.show')])
    ...
    <div class="card mt-3">
        <div class="card-body">
            <h5 class="h5 blue">@lang('Support')</h5>
            <h6 class="h6 gray">@lang('We are here to help')</h6>
            <hr>
            <ul class="sidebar-ul">
                <li class="mb-2"><a class="a-underline blue coming-soon" href="javascript:void(0)">@lang('Create a ticket')</a></li>
                <li class="mb-2"><a class="a-underline blue coming-soon" href="javascript:void(0)">@lang('Request Call Back')</a></li>
                <li><a class="a-underline blue coming-soon" href="javascript:void(0)">@lang('Chat with us')</a></li>
            </ul>
        </div>
    </div>
    {{--ENDTODO--}}
