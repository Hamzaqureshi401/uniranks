...
//            $inputs ['created_by'] = \Auth::id();
    ...
    public function setFormData(SchoolSponsoredEvent $event = null){
        ...
        $this->form['event_datetime'] = $event?->event_datetime?->toDateTimeString() ?? '';
        $this->form['deadline'] = $event?->deadline?->toDateTimeString() ?? '';
    ...
    public function viewOffers(SchoolSponsoredEvent $event){
        $event->load(['offers.university.country','offers.agent.country']);
        $this->selected_event = $event;
