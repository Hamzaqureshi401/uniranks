...
//    protected $queryString = ['branch_id'=>['except'=>'','as'=>'b']];
    ...
    public function setData()
    {
        ...
        $this->school = \Auth::user()->schools()->findOrFail($school_id)->fresh();
    ...
    public function save()
    {
        ...
        if ($this->school->id == \Auth::user()->selected_school->id) {
            setUserSelectedSchool($this->school);
        }
        $this->branch_id = null;
        $this->setData();
        $this->loadCities();
    ...
    public function emaitForJS(){
        $this->emit('refresh');
        $this->emit('addSearchBarWithSelect');
    }
