...
class Performance extends Component
{
    ...
    {
        $this->fair->loadCount(['arrivedUniversities','universitiesNotArrived', 'invitation'=>fn($q)=>$q->whereNotNull('university_id'), 'attendance','ratedBy']);
        $this->school_students_count = User::whereSelectedSchoolStudents()->count();
        $this->sm_credit = [
