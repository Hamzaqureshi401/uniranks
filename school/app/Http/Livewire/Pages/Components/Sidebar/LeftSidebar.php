...
class LeftSidebar extends Component
{
    ...
    public function mount()
    {
        ...
        $this->routes = [
            ...
            ['icon'=>'fa-location-pin','id'=>'school-location-info','name'=>'location_info','title'=>'School Location Info'],
            ['icon'=>'fa-users', 'id'=>'school-student-info','name'=>'student_info','title'=>'School Student Info'],
        ...
        $this->profileroutes = [
            ...
            ['icon'=>'fa-location-pin','id'=>'user-emails', 'name'=>'user-emails','title'=>'Primary Email Address'],
