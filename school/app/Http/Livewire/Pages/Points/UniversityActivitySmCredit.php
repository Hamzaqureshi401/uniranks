...
{
    /**
     * @var \App\Models\PointingSystem\PointTransaction $histories;
    ...
    public function mount()
    {
        ...
        $this->histories = $school->pointsHistory()
            ...
            ->groupBy('point_type_id')
            ->selectRaw("count(*) as transaction_count, point_type_id, sum(points_in) as transaction_sum")
            ->with('pointType')
            ->get();
    }
