 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|User[] $admin
...
class University extends Model
{
    ...
    protected $fillable = ['institute_id','national_id', 'university_name', 'email', 'phone', 'address1', 'address2', 'country_id', 'city_id', 'website', 'latitude', 'longitude', 'map_link', 'status', 'moderator_id'];
    ...
    public function getUniversityNameAttribute($value){
