 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|Hobby[] $hobbies
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereSelectedSchoolStudents()
...
class User extends Authenticatable //implements MustVerifyEmail
{
    ...
    protected $with = ['school', 'userBio', 'roles','preferences.currency'];
    ...
    function scopeWhereSelectedSchoolStudents($query)
    {
    ...
    public function sendPasswordResetNotification($token)
    {
        ...
        //TODO FIX AFTER SEND GRID ISSUE
...
//        }
    ...
    {
        return $this->belongsToMany(School::class,UserSchool::class,'user_id','school_id')->withPivot(['id'])
