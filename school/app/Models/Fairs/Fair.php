 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|PointTransaction[] $schoolCreditEarned
...
//        $start = Carbon::createFromFormat('Y-m-d H:i:s', $this->start_date)->toDateString();
    ...
    public function schoolCreditEarned(): MorphMany
    {
        return $this->morphMany(PointTransaction::class, 'earned_for');
    }
