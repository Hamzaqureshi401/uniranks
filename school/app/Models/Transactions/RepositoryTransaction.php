 ...
 * @method static \Illuminate\Database\Eloquent\Builder|RepositoryTransaction whereEventPackageClientId($value)
...
class RepositoryTransaction extends Model
{
    ...
    protected $fillable = ['university_id','agent_id','description','event_package_client_id' ,'avg_ur_cost','quantity_purchased','ur_credit_out','ur_credit_in','by_user_id'];
