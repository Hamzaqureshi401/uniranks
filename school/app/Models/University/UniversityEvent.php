 ...
 * @property-read UniversityEventType|null $type
 ...
 * @mixin \Eloquent
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\University\UniversityEventInvitation[] $eventInvitations
 * @property-read int|null $event_invtations_count
 */
class UniversityEvent extends Model
{
    ...
    public function eventInvitations(){
        return $this->hasMany(UniversityEventInvitation::class,'university_event_id');
    }
}
