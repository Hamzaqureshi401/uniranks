 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\General\CurriculumBranch[] $branches
...
class Curriculum extends Model
{
    ...
    {
        return $this->hasMany(CurriculumBranch::class,'curriculum_id');
    }
