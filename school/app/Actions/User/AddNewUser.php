...
class AddNewUser
{
    ...
    protected $sub_account;

    public function handle(array $input, $as_sub_account=true)
    {
        $this->sub_account = $as_sub_account;
    ...
    protected function addUserRules(): array
    {
        return [
            ...
            'user_account_state.email' => ['required', 'string', 'email:rfc,filter', 'max:255','unique:users,email'],
    ...
    protected function getInputsCollection($input): \Illuminate\Support\Collection
    {
        ...
        $input = array_merge($input,[
            ...
            'main_user_id' => ($this->sub_account ? \Auth::id() : null),
        ]);
