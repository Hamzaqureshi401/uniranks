 ...
 * @method static \Illuminate\Database\Eloquent\Builder|UniversityLead whereArchived($value)
 * @method static \Illuminate\Database\Eloquent\Builder|UniversityLead whereLeadSourceId($value)
 * @mixin \Eloquent
 */
