 ...
 *
 * @property int $id
 * @property int|null $university_event_type_id
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, User> $attendance
 * @property-read int|null $attendance_count
 * @property-read Cities|null $city
 * @property-read Countries|null $country
 * @property-read User|null $createdBy
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Curriculum> $curriculums
 * @property-read int|null $curriculums_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, FairEditRequest> $editRequests
 * @property-read int|null $edit_requests_count
 * @property-read FairType|null $fairType
 * @property-read FeeRange|null $feeRange
 * @property-read \Illuminate\Database\Eloquent\Collection<int, FairEditHistory> $history
 * @property-read int|null $history_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, School> $invitedSchool
 * @property-read int|null $invited_school_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Major> $majors
 * @property-read int|null $majors_count
 * @property-read User|null $processedBy
 * @property-read \App\Models\University\UniversityEventType|null $type
...
class UniversityEvent extends Model
{
    ...
    {
        return $this->belongsTo(UniversityEventType::class,'university_event_type_id');
    }
