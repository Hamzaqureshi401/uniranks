 ...
 * @property-read mixed $is_multiple_sponsors_allowed
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\School\SchoolSponsoredEventOffer> $offers
 * @property-read int|null $offers_count
 * @property-read User|null $processedBy
 * @property-read School|null $school
 * @property-read \Illuminate\Database\Eloquent\Collection<int, University> $sponsorOfferedByUniversities
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|SchoolSponsoredEvent whereCurrencyId($value)
...
class SchoolSponsoredEvent extends Model
{
    ...
    protected $fillable = ['name','description','sponsored_event_type_id','amount','currency_id','event_datetime','deadline',
    ...
    protected $appends = [
        'is_multiple_sponsors_allowed'
    ];

    public function getIsMultipleSponsorsAllowedAttribute(){
        return $this->allow_multiple_sponsors ? "Yes" : "No";
    }
