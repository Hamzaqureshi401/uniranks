 ...
 * @method static \Illuminate\Database\Eloquent\Builder|FairReserveSessionRequest whereAgentId($value)
...
class FairReserveSessionRequest extends Model
{
    ...
    protected $fillable = [
        'fair_session_id','university_id','agent_id','status','requested_by','processed_by','processed_at','remarks'
    ];
