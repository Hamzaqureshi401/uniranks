 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Fairs\FairReserveSessionRequest> $reservationRequests
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|FairSession whereAgentId($value)
...
class FairSession extends Model
{
    ...
    protected $fillable = ['fair_id', 'university_id','agent_id', 'major_id', 'user_id', 'start_at', 'end_at', 'duration', 'hall_number'];
