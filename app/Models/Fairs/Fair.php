...
class Fair extends Model
{
    ...
    protected $with = ['school:id,school_name'];

    protected $casts = ['school_curriculums' => 'array','start_date'=>'datetime','end_date'=>'datetime'];
    ...
    public function getFairNameAttribute($value){
        return $value ?: $this->school?->school_name;
    }
    public function getDatetimeAttribute(): string
    {
        ...
        $startHr = $start->format('g:i A');
        $endHr = $end->format('g:i A');
        $endDate= $sameDay ?  $startHr." - ".$endHr : $startHr. " - ".$end->toDayDateTimeString();
        return "{$start->isoFormat('ddd, MMM D, Y')} $endDate";
    }
    ...
    {
        return $this->belongsToMany(University::class, Invitation::class)->wherePivot('accepted_by_school', \AppConst::REGISTARTION_ACCEPTED);
    }
