...
class CreateOpenDays extends Component
{
    ...
    public function mount()
    {
        ...
        $this->setData();
        $this->title = (!empty($this->fair) ? 'Edit' : 'Create New') . ' Open day';
    }

    public function render()
    {
        $no_schools = $this->getSchoolsCount();
        return view('livewire.university-events.open-days.create-open-days',compact('no_schools'));
    }
    ...
    public function save()
    {
        ...
        $create_university_events = [
            'university_event_type_id' => \AppConst::UNIVERSITY_EVENT_TYPE_OPENDAY,
            'title' => empty($this->title) ? $uni->university_name. ' Open day' : $this->title,
    ...
    {
        $this->redirect(route('admin.events.openDays.list'));
    }
}
